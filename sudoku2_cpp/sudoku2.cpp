...
// load src
Fr_sub(&expaux[2],&signalValues[mySignalStart + 0],&signalValues[mySignalStart + 1]); // line circom 7
Fr_div(&expaux[0],&circuitConstants[0],&expaux[2]); // line circom 7
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_sub(&expaux[3],&signalValues[mySignalStart + 0],&signalValues[mySignalStart + 1]); // line circom 8
Fr_mul(&expaux[1],&signalValues[mySignalStart + 2],&expaux[3]); // line circom 8
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[0]); // line circom 8
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 8. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[1]); // line circom 14
...
Fr_lt(&expaux[0],&lvar[2],&lvar[1]); // line circom 15
while(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[0]); // line circom 14
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[1]); // line circom 14
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[3]); // line circom 28
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 1)];
// load src
Fr_shr(&expaux[1],&signalValues[mySignalStart + 0],&lvar[1]); // line circom 29
Fr_band(&expaux[0],&expaux[1],&circuitConstants[0]); // line circom 29
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_sub(&expaux[3],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 1)],&circuitConstants[0]); // line circom 30
Fr_mul(&expaux[1],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 1)],&expaux[3]); // line circom 30
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 30
...
PFrElement aux_dest = &lvar[0];
// load src
Fr_pow(&expaux[3],&circuitConstants[4],&lvar[1]); // line circom 31
Fr_mul(&expaux[2],&expaux[3],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 1)]); // line circom 31
Fr_add(&expaux[0],&lvar[0],&expaux[2]); // line circom 31
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[0]); // line circom 28
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[3]); // line circom 28
}
Fr_eq(&expaux[0],&lvar[0],&signalValues[mySignalStart + 0]); // line circom 33
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 0];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 0],&circuitConstants[0]); // line circom 41
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 0];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 0],&circuitConstants[5]); // line circom 42
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[1]); // line circom 54
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[1]); // line circom 55
while(Fr_isTrue(&expaux[0])){
Fr_sub(&expaux[3],&signalValues[mySignalStart + (((9 * Fr_toInt(&lvar[1])) + (1 * Fr_toInt(&lvar[2]))) + 0)],&signalValues[mySignalStart + (((9 * Fr_toInt(&lvar[1])) + (1 * Fr_toInt(&lvar[2]))) + 81)]); // line circom 57
Fr_mul(&expaux[1],&signalValues[mySignalStart + (((9 * Fr_toInt(&lvar[1])) + (1 * Fr_toInt(&lvar[2]))) + 0)],&expaux[3]); // line circom 57
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 57
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[0]); // line circom 55
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[1]); // line circom 55
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[0]); // line circom 54
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[1]); // line circom 54
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[1]); // line circom 61
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
...
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[1]); // line circom 62
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[1],&circuitConstants[2]); // line circom 63
...
PFrElement aux_dest = &lvar[2];
// load src
Fr_add(&expaux[0],&lvar[2],&circuitConstants[0]); // line circom 62
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[2],&circuitConstants[1]); // line circom 62
...
PFrElement aux_dest = &lvar[1];
// load src
Fr_add(&expaux[0],&lvar[1],&circuitConstants[0]); // line circom 61
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[1]); // line circom 61
